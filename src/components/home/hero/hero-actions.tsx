    ...
    <div className="hero-reveal hero-reveal-actions mt-7 max-[359px]:mt-5">
      <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-5">
        <Link
          ...
          className={`hero-cta group inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-[var(--radius-md)] bg-[var(--color-accent)] px-6 text-sm font-bold text-[var(--color-ink)] shadow-[var(--shadow-on-photo)] transition-colors duration-200 ease-out hover:bg-[var(--color-accent-hover)] focus-visible:bg-[var(--color-accent-hover)] ${focusRingOnDark} sm:w-auto`}
        >
          {t.tour}
          <ArrowRight
