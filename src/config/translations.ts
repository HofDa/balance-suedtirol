...
const translations = {
  de: {
    ...
    projectDetail: {
      ...
      galleryTitle: "Einblicke ins Projekt",
      sketchTitle: "Projektskizze",
      ...
      shareOptions: "Weitere Optionen",
      copyLink: "Link kopieren",
      linkCopied: "Link kopiert",
      copyFailed: "Kopieren nicht möglich. Bitte den Link unten manuell kopieren.",
      instagramHelp: "Story-Grafik herunterladen und in Instagram hochladen. Den Projektlink als Link-Sticker hinzufügen. Für einen Beitrag kannst du den Projekttext kopieren.",
      downloadStory: "Story-Grafik herunterladen",
      copyPost: "Projekttext und Link kopieren",
      postCopied: "Projekttext und Link kopiert",
      storyCallToAction: "Mehr zum Projekt: Link-Sticker öffnen",
      downloadFailed: "Die Grafik konnte nicht erstellt werden. Bitte erneut versuchen.",
  ...
  it: {
    ...
    projectDetail: {
      ...
      galleryTitle: "Uno sguardo al progetto",
      sketchTitle: "Schema del progetto",
      ...
      shareOptions: "Altre opzioni",
      copyLink: "Copia il link",
      linkCopied: "Link copiato",
      copyFailed: "Copia non riuscita. Copia manualmente il link qui sotto.",
      instagramHelp: "Scarica la grafica e caricala in una storia Instagram. Aggiungi il link del progetto con l’adesivo Link. Per un post puoi copiare il testo del progetto.",
      downloadStory: "Scarica la grafica per la storia",
      copyPost: "Copia testo e link",
      postCopied: "Testo e link copiati",
      storyCallToAction: "Scopri il progetto: apri l’adesivo Link",
      downloadFailed: "Impossibile creare la grafica. Riprova.",
  ...
  en: {
    ...
    projectDetail: {
      ...
      shareOptions: "More options",
      copyLink: "Copy link",
      linkCopied: "Link copied",
      copyFailed: "Unable to copy. Please copy the link below manually.",
      instagramHelp: "Download the graphic and upload it to an Instagram Story. Add the project URL with a Link sticker. For a post, you can copy the project text.",
      downloadStory: "Download Story graphic",
      copyPost: "Copy project text and link",
      postCopied: "Project text and link copied",
      storyCallToAction: "Explore the project: open the Link sticker",
      downloadFailed: "Unable to create the graphic. Please try again.",
